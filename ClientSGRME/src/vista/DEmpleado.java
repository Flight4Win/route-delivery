 ...
 * @author ferna
 */
public class DEmpleado extends javax.swing.JDialog implements IntVentanas{

    /**
     * Creates new form DRegistrarEmpleado
     */
    private boolean operacionRegistrar = false; 
    ...
    public DEmpleado(java.awt.Frame parent, boolean modal) {//registrar
        super(parent, modal);
        initComponents();
        /*------------------------------*/
        ...
        centrarPantalla();
        /*------------------------------*/
        this.operacionRegistrar = true;
         /*------------------------------*/
        cbDeshabilitar.setVisible(false);
        tfCodigo.setEditable(false);
        lbErrorDNI.setVisible(false);     
        if(operacionRegistrar){
            bModificarDatosEmpleado.setVisible(false);
    ...
    public DEmpleado(java.awt.Frame parent, boolean modal, boolean operacionRegistrar, Empleado empleado) {//buscar
        super(parent, modal);
        initComponents();
        /*------------------------------*/
        ...
        /*------------------------------*/
        this.operacionRegistrar = operacionRegistrar;
    ...
    private void initComponents() {
        ...
        bgPerfiles = new javax.swing.ButtonGroup();
        ...
        bgPerfiles.add(rbAdministrador);
                    ...
                    .addGroup(pFondoLayout.createSequentialGroup()
                        ...
                        .addGroup(pFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pFondoLayout.createSequentialGroup()
                                ...
                                .addGap(62, 62, 62)
                                .addGroup(pFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(lbApellidoPaterno, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(tfApellidoPaterno, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(pFondoLayout.createSequentialGroup()
                                .addGroup(pFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(pFondoLayout.createSequentialGroup()
                                        .addGroup(pFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            .addComponent(lbCorreo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(tfCorreo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addGroup(pFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(tfCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(lbCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(tfApellidoMaterno, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(lbApellidoMaterno, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                        .addGap(62, 62, 62)
                                        .addGroup(pFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(lbDNI, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            ...
                                            .addComponent(lbTelefono, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(lbDominio, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(cbDominio, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))))
                                    .addComponent(tfDireccion, javax.swing.GroupLayout.PREFERRED_SIZE, 432, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        }
    ...
    private void agregarPersona(){
        ...
        persona = new Persona(/*pc.cantidad(),*/ 
    ...
    private void agregarEmpleado(){
        ...
        try{
            ...
            Usuario u = new Usuario(tfNombres.getText(), tfCorreo.getText()+(String)cbDominio.getSelectedItem(), contrasenhaEncriptada, perfil);            
...
//            java.util.logging.Logger.getLogger(DEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                DEmpleado dialog = new DEmpleado(new javax.swing.JFrame(), true);
...
//    }
    ...
    private javax.swing.ButtonGroup bgPerfiles;
