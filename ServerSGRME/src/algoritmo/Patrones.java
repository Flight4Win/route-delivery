...
public class Patrones<T>{
    ...
    public boolean DFS_validador(T actual, T destination,T anterior, ArrayList<ArrayList<PlanVuelo>> soluciones,
                    ...
                    if(!patronSolucion.contains(t)){// si no está considera en la solución
                        ...
                        if(veces<3 && tiempo>=0){ //Si el tamaño de caminos es 3 [o si el tiempo se terminó]
                            ...
                            if(horaActual > t.getHora_ini()){ //Para manejar correctamente los tiempos de salida de las ciudades
                                ...
                                if(DFS_validador ((T)(Integer)(Object)t.getDestino().getId(), destination, actual, soluciones, patron,patronSolucion,veces+1,tiempo-esperaConVuelo,t.getHora_fin(),grafito,false)) return true;
                            }
                            else{
