...
public class TestHilosEventos {
    ...
    public static void main(String[] args) {
        ...
        Despachador despachador = new Despachador(LocalDateTime.parse(strFecha,formateador));
        despachador.leerPaquetes();                       
        
        despachador.AgregarManejador(temporizador);
        
        temporizador.ActivarTimer();
        despachador.ActivarTimer();
    }
